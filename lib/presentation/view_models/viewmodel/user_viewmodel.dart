import 'package:dish_dash/utils/observer/order_observer/order_manager.dart';
...
import '../../../utils/observer/product_avaliablity_observer/product_stock_management.dart';
import '../../../utils/strategy/delivery_strategy/models/courier_delivery.dart';
import '../../../utils/strategy/delivery_strategy/models/delivery.dart';
import '../../../utils/strategy/delivery_strategy/models/market_delivery.dart';
import '../../../utils/strategy/delivery_strategy/models/self_delivery.dart';
import '../../../utils/strategy/identification_strategy/models/AkbankIdentificationStrategy.dart';
import '../../../utils/strategy/identification_strategy/models/GarantiBankIdentificationStrategy.dart';
import '../../../utils/strategy/identification_strategy/models/IdentificationStrategy.dart';
import '../../../utils/strategy/identification_strategy/models/ZiraatBankIdentificationStrategy.dart';
import '../../ui/screens/payment/components/card_front.dart';
...
class UserViewModel extends ChangeNotifier {
  ...
  void manageUserOrderStatus() {
    var orderObserver = UserOrderNotificationObserver(currentUser);
    var orderManager = OrderStatusManager();
    orderManager.register(orderObserver, currentUser.orderList);
